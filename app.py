...
@app.route('/')
def index():
    return('<center><h1> JSON API for predicting Coronary Heart Disease in a patient. </h1>'+
            '<h2> An example query is <a href="https://cardio-care-predictor-api.onrender.com//predict?age=31&sex=1&cigs=5&chol=230&sBP=280&dia=0&dBP=90&gluc=87&hRate=84">this</a></h2>'+
            ...
            '<p>Made with 💙 by <a href="https://github.com/amansrv">Aman Srivastava</a></p></center>')
